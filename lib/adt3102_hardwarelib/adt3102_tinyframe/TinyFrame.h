...
1,Tx
  TYPE  | data type |
 0x0A00 |   float   | number(uint32) array(range, velocity, power, phase0, phase1, angleH, angleV)
 0x0A01 |   float   | number(uint32) array(range, power, phase1, angleH)
 0x0A02 |   float   | number(uint32) array(range, phase1)
 0x0A03 |   float   | breathrate
 ---------------------------------------------------------------------------------------------------
 ...
 0x0B06 |   int16   | 0x0055: frame ADC transfer start, 0xaa: frame ADC transfer stop
 ---------------------------------------------------------------------------------------------------
